...
/*  errors: new error (15-08-23) idfk what's wrong
    test line 239- see if the '#' still prints
...
class TreasureHunt {
  ...
  public void move(){
    ...
    if(newRow >= 0 && newRow < 10 && newCol >= 0 && newCol < 10 && isExplored(newRow, newCol) == false){
