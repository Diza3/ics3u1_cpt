...
/*  errors: game does not continue to play when user enters 'S' (stay) into the escape variable, 
    ...
    new error (shown in .png file) is kind of fixed, however it does not display the correct value being subtracted from the treasureTotal
...
class TreasureHunt {
  ...
  public void explorePosition(int i, int j){
    ...
    if(gameBoard[i][j] == 'T'){
      ...
      System.out.println("You have found a gang of pirates. They have stolen " + pVal + " of your gold doubloons."); // change pVal to acc value
      System.out.println("Your treasure count is " + treasureTotal + " gold doubloons.");
       }
      else{
